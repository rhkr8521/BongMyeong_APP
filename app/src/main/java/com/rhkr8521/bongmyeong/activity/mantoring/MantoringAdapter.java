...
public class MantoringAdapter extends RecyclerView.Adapter<MantoringAdapter.MainViewHolder> {
    //    private int mBackground;
    private ArrayList<MainInfo> mValues = new ArrayList<>();

    public MantoringAdapter(Context mContext) {
...
//        mBackground = mTypedValue.resourceId;
    ...
    @Override
    public MantoringAdapter.MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

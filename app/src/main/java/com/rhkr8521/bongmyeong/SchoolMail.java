...
/**
 * Created by rhkr8521 on 2017-09-09.
 */

public class SchoolMail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv.setWebViewClient(new SchoolMail.MyWeb() {
            @Override
        ...
        wv.loadUrl("http://cbm.hs.kr/m/main.jsp?SCODE=S0000000727&mnu=M001005001");
        ...
        wv.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                ...
                try {
                    ...
                    if (ContextCompat.checkSelfPermission(SchoolMail.this,
                            android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                            != PackageManager.PERMISSION_GRANTED) {
                        // Should we show an explanation?
                        if (ActivityCompat.shouldShowRequestPermissionRationale(SchoolMail.this,
                                android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            Toast.makeText(getBaseContext(), "파일 다운로드를 위해\n권한동의가 필요합니다.", Toast.LENGTH_LONG).show();
                            ActivityCompat.requestPermissions(SchoolMail.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                    110);
                        } else {
                            Toast.makeText(getBaseContext(), "파일 다운로드를 위해\n권한동의가 필요합니다.", Toast.LENGTH_LONG).show();
                            ActivityCompat.requestPermissions(SchoolMail.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE},

...
public class SchoolSchedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv.setWebViewClient(new SchoolSchedule.MyWeb() {
            @Override
        ...
        wv.loadUrl("http://cbm.hs.kr/m/main.jsp?SCODE=S0000000727&mnu=M001007006&year=2017&month=8&day=7");
        ...
        wv.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimeType, long contentLength) {
                ...
                try {
                    ...
                    if (ContextCompat.checkSelfPermission(SchoolSchedule.this,
                            android.Manifest.permission.WRITE_EXTERNAL_STORAGE)
                            != PackageManager.PERMISSION_GRANTED) {
                        // Should we show an explanation?
                        if (ActivityCompat.shouldShowRequestPermissionRationale(SchoolSchedule.this,
                                android.Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            Toast.makeText(getBaseContext(), "파일 다운로드를 위해\n권한동의가 필요합니다.", Toast.LENGTH_LONG).show();
                            ActivityCompat.requestPermissions(SchoolSchedule.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                    110);
                        } else {
                            Toast.makeText(getBaseContext(), "파일 다운로드를 위해\n권한동의가 필요합니다.", Toast.LENGTH_LONG).show();
                            ActivityCompat.requestPermissions(SchoolSchedule.this, new String[]{android.Manifest.permission.WRITE_EXTERNAL_STORAGE},
